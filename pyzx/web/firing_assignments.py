...
def create_firing_verification(d: BaseGraph[int, Tuple[int, int]], ordering: GraphOrdering) -> GF2:
    ...
    for s, t in d.edges():
        if d.type(s) != VertexType.BOUNDARY and d.type(t) != VertexType.BOUNDARY:
