...
def circuit_to_graph(
    ...
    for gate in c.gates:
        ...
        if gate.name == 'InitAncilla':
            ...
            # Model reset as post-selection ⟨0| then preparation |0⟩,
            # creating a wire break.  See the Reset gate docstring for
            # caveats about post-selection vs. true quantum reset.
            l = gate.label # type: ignore
            ...
            # Effect vertex: discard the old state by projecting onto ⟨0|.
            effect_v = g.add_vertex(VertexType.X, q, r, 0)
