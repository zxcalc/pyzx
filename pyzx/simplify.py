...
#rename fuse_simp then crate function that spider_fuses until no longer doing anything
just_spider_simp = RewriteSimpDoubleVertex(check_fuse, unsafe_fuse)
