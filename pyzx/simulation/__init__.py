...
After adding a decomposition, ensure its enum name is included atop simulation/decompositions/__init__py and its file is imported
at the bottom.
...
ensure its enum name is included atop simulation/strategies/__init__py and its file is imported at the bottom.
"""
