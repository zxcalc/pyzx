"""
The cat4 state decomposition introduced in https://arxiv.org/pdf/2202.09202.
"""
...
def decompose(g:BaseGraph[VT,ET], v:VT) -> SumGraph:
    """Apply the cat4 decomposition to a vertex v of graph g."""
...
@register_validity_checker(Decomp.CAT_4)
