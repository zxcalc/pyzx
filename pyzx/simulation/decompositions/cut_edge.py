"""
This decomposition allows an edge to be cut, producing two terms, as used in https://arxiv.org/pdf/2403.10964
...
def decompose(g:BaseGraph[VT,ET], e:ET, ty:VertexType=VertexType.Z) -> SumGraph:
    ...
    x0,x1 = g.row(e_st[0]), g.row(e_st[1])
    y0,y1 = g.qubit(e_st[0]), g.qubit(e_st[1])
