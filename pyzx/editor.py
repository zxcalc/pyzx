...
When you are happy with the changes, click "Push changes" to change the underlying PyZX graph g.

When conversely you want to see a change in g in Python reflected in the editor,
call e.update().
